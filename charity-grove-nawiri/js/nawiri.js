(function () {
  ...
  (function () {
    ...
    /* Page-specific nav CTA (global header defaults to Book a Session → /book/) */
    var navCta = document.querySelector("nav.top .nav-cta");
    if (navCta) {
      var body = document.body;
      var navCtaConfig = null;
      if (body.classList.contains("page-book")) {
        navCtaConfig = { label: "\u2193 Book Now", href: "#book" };
      } else if (body.classList.contains("page-walk-with-us")) {
        navCtaConfig = { label: "\u2764 Give Now", href: "#give" };
      } else if (body.classList.contains("page-initiative")) {
        navCtaConfig = { label: "\u2764 Support", href: "/walk-with-us/" };
      }
      if (navCtaConfig) {
        navCta.textContent = navCtaConfig.label;
        navCta.setAttribute("href", navCtaConfig.href);
      }
